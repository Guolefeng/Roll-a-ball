...
extern Il2CppCodeGenString* _stringLiteral1454441430;
...
extern "C"  void PlayerController_OnTriggerEnter_m2196551076 (PlayerController_t4148409433 * __this, Collider_t3497673348 * ___other0, const MethodInfo* method)
{
	...
	}
	{
		...
		NullCheck(L_1);
		bool L_2 = GameObject_CompareTag_m2797152613(L_1, _stringLiteral1454441430, /*hidden argument*/NULL);
		if (!L_2)
		{
			goto IL_0035;
		}
...
extern Il2CppCodeGenString* _stringLiteral1361090013;
...
extern "C"  void PlayerController_SetCountText_m692303570 (PlayerController_t4148409433 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		String_t* L_3 = String_Concat_m2596409543(NULL /*static, unused*/, _stringLiteral1361090013, L_2, /*hidden argument*/NULL);
		NullCheck(L_0);
...
{
	{
		...
		Vector3__ctor_m2638739322(&L_1, (30.0f), (30.0f), (30.0f), /*hidden argument*/NULL);
